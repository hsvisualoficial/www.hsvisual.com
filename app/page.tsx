...
const WEBHOOK_URL =
  ...
  "https://seu-n8n.dominio.com/webhook/hsvisual-quiz";

// Global quiz modal trigger — suporta serviço pré-selecionado
let _openQuiz: ((service?: string) => void) | null = null;
function openQuizModal(service?: string) {
  _openQuiz?.(service);
}

const WA_NUMBER = "5511953611000";
const WA_MSG = encodeURIComponent(
  "Olá Helder, vim pelo site e quero elevar o padrão do meu marketing!",
);
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow:
          "0 0 0 2px rgba(197,164,103,0.45), 0 0 24px rgba(197,164,103,0.25)",
        textDecoration: "none",
      }}
    >
      <span
      ...
      {!done && (
        ...
        >
          ...
          <div
            ...
            style={{
              backgroundImage:
                "linear-gradient(rgba(197,164,103,0.8) 1px, transparent 1px), linear-gradient(90deg, rgba(197,164,103,0.8) 1px, transparent 1px)",
    ...
    >
      ...
      <div
        ...
        style={{
          zIndex: 1,
          background:
            "linear-gradient(to right, #050505 0%, #050505 28%, rgba(5,5,5,0.92) 40%, rgba(5,5,5,0.60) 52%, rgba(5,5,5,0.18) 66%, transparent 78%)",
        }}
      />
      ...
      <div
        ...
        style={{
          ...
          height: "22%",
          background:
            "linear-gradient(to top, #050505 0%, rgba(5,5,5,0.55) 55%, transparent 100%)",
        }}
      />
      ...
      <div className="relative z-10 h-full flex flex-col">
        ...
        >
          ...
          >
            Tráfego Pago · Sites · Automação · IA
          </motion.div>
          ...
          >
            Sua empresa já fatura. Mas depende de indicação, não tem um sistema
            de aquisição que funcione sozinho e perde leads todos os dias.
            Existe uma saída — e começa aqui.
          </motion.p>
        ...
        <div className="relative z-10 w-full flex-shrink-0">
          ...
          >
            ...
            <div className="flex items-center gap-7">
              ...
              >
                <path
                  d="M22.54 6.42a2.78 2.78 0 0 0-1.94-1.96C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 1.96A29 29 0 0 0 1 12a29 29 0 0 0 .46 5.58 2.78 2.78 0 0 0 1.94 1.96C5.12 20 12 20 12 20s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-1.96A29 29 0 0 0 23 12a29 29 0 0 0-.46-5.58z"
                  stroke="#A0A0A0"
                  strokeWidth="1.4"
                />
                <polygon
  ...
  return (
    <motion.section
      ...
      style={{
        height: "60px",
        background:
          "linear-gradient(90deg, rgba(5,5,5,1) 0%, rgba(5,5,5,0.98) 50%, rgba(5,5,5,1) 100%)",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-16">
          ...
          >
            ...
            >
              A diferença entre campanhas que{" "}
              <span className="font-display-italic text-gold">sangram</span> e
              as que{" "}
          ...
          >
            A maioria das empresas perde dinheiro em anúncios porque não sabe o
            que está errado. Na HS Visual, cada decisão tem base em dados reais
            — sem suposição, sem desperdício.
          </motion.p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {pillars.map((p, i) => (
            ...
            >
              ...
              <div className="font-body font-medium text-cream/85 text-sm mb-3">
                {p.title}
              </div>
              <p className="font-body font-light text-cream/35 text-xs leading-relaxed">
                {p.desc}
              </p>
            </motion.div>
          ))}
  ...
  return (
    <section className="py-16 px-6 bg-obsidian/20 border-t border-cream/5">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="font-body text-[10px] tracking-[0.4em] uppercase text-gold/55 mb-4">
          ...
          {objecoes.map((item, i) => (
            ...
            >
              <div className="flex items-start gap-3 mb-4">
                ...
                <span className="font-body font-medium text-cream/75 text-sm leading-snug">
                  {item.q}
                </span>
              </div>
              <p className="font-body font-light text-cream/35 text-xs leading-relaxed pl-4">
                {item.a}
              </p>
            </motion.div>
          ))}
...
function TiltCard({
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (cardRef.current) {
        cardRef.current.style.transform = `perspective(900px) rotateX(${cur.current.rx}deg) rotateY(${cur.current.ry}deg)`;
      }
      if (glareRef.current) {
        glareRef.current.style.background = `radial-gradient(circle at ${cur.current.gx}% ${cur.current.gy}%, rgba(197,164,103,0.13) 0%, transparent 60%)`;
    ...
    <div ref={ref} className="mt-6 mb-1">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  i === bars.length - 1
                    ? "0 0 12px rgba(197,164,103,0.30)"
                    : "none",
              }}
              className="w-full"
            />
      ...
      <div className="flex gap-[6px] mt-2">
        {bars.map((b) => (
          <span
            key={b.label}
            className="flex-1 text-center text-[8px] font-body text-cream/20 tabular-nums"
          >
            {b.label}
          </span>
        ))}
...
const pillars = [
  {
    ...
    answer:
      "Cada post é calculado para posicionar seu preço antes de você abrir a boca. Quem chega até você já sabe quanto custa — e quer pagar. Você para de competir por preço e começa a ser escolhido.",
  ...
  },
  {
    ...
    question: "Como isso me traz dinheiro?",
    answer:
      "Paramos de gastar com alcance vago. Seus anúncios chegam só para quem tem poder de compra e intenção real — quando estão prontos para decidir. ROAS médio de 8,4× comprovado em carteira.",
  ...
  },
  {
    ...
    question: "Como isso me traz dinheiro?",
    answer:
      "Às 2h da manhã, um lead entra pelo seu anúncio. Em menos de 2 minutos, nossa IA responde, qualifica e agenda. Você acorda com uma reunião marcada — sem perder lead por demora.",
    ...
    <section className="py-8 px-6 bg-obsidian/20 overflow-hidden">
      <div className="max-w-7xl mx-auto relative">
        <AmbientOrb
          ...
          height={600}
          speed={0.18}
          style={{ left: "50%", top: "20%", marginLeft: -300 }}
        />
        ...
        <div className="text-center mb-24 relative z-10">
          ...
          >
            Três pilares integrados. Cada um com função clara. Juntos,
            transformam sua marca em máquina de vendas.
          </motion.p>
        </div>
              ...
              <TiltCard className="glass rounded-2xl px-8 py-10 overflow-hidden group h-full flex flex-col items-center text-center">
                ...
                <div className="relative mb-7">
                  ...
                  <div className="w-20 h-20 rounded-full border border-gold/20 flex items-center justify-center">
                    {/* Anel interno */}
                    <div
                      className="w-14 h-14 rounded-full border border-gold/35 bg-gold/5 flex items-center justify-center"
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "radial-gradient(circle, rgba(197,164,103,0.15) 0%, transparent 70%)",
                    }}
                  />
                </div>
                ...
                {/* The question */}
                <div
                  className="font-display-italic text-gold/55 mb-5 leading-snug"
                ...
                {/* Answer */}
                <p
                  className="font-body font-light text-cream/45 leading-relaxed mb-8 flex-1"
                ...
                <div
                  ...
                  style={{
                    background: `radial-gradient(ellipse 80% 60% at 50% 0%, hsla(${p.hue},40%,20%,0.10), transparent)`,
                  }}
                />
              </TiltCard>
            </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 relative">
          {steps.map((step, i) => (
            ...
            >
              ...
              <div className="font-body font-medium text-cream/85 text-sm mb-3 uppercase tracking-widest">
                {step.title}
              </div>
              <p className="font-body font-light text-cream/35 text-xs leading-relaxed">
                {step.desc}
  ...
  useEffect(() => {
    ...
    const tween = gsap.to(obj, {
      ...
      onUpdate() {
        ...
        counterRef.current.textContent = `+ R$ ${millions}.${remainder.slice(0, 3)}.${remainder.slice(3)}`;
      },
    });
  ...
  const stats = [
    {
      value: `${roas}%`,
      label: "ROAS Médio",
      desc: "retorno sobre cada real investido",
      sparkData: [420, 510, 590, 680, 760, 847],
    },
    {
      value: `${(leads / 1000).toFixed(0)}k+`,
      label: "Leads Qualificados",
      desc: "com intenção real de comprar",
      sparkData: [18, 28, 35, 42, 48, 52],
    },
    {
      value: `${brands}+`,
      label: "Marcas Atendidas",
      desc: "em mercados de alto padrão",
      sparkData: [80, 95, 105, 115, 125, 130],
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-24">
          <div>
            ...
            <p className="font-body font-light text-cream/50 leading-relaxed max-w-md">
              Estratégia sob medida para negócios que buscam crescer. Cada
              campanha rastreada do clique ao fechamento — sem achismo, sem
              capital perdido.
            </p>
          </div>
          ...
          <TiltCard
            className="glass rounded-2xl p-10 overflow-hidden"
            intensity={6}
          >
            {/* Ambient glow */}
            ...
            <div
              ...
              style={{
                ...
                lineHeight: 1,
                textShadow:
                  "0 0 40px rgba(197,164,103,0.22), 0 0 80px rgba(197,164,103,0.08)",
              }}
            >
              + R$ 0.000.000
            </div>
          ...
          {stats.map((stat, i) => (
            ...
            >
              <TiltCard className="glass rounded-xl p-6 overflow-hidden group hover:border-gold/20 transition-colors duration-500">
                ...
                <div className="text-xs font-body font-medium text-gold/70 mb-1">
                  {stat.label}
                </div>
                <div className="text-[11px] font-body text-cream/30">
                  {stat.desc}
                </div>
              </TiltCard>
            </motion.div>
...
function QuizTrigger() {
  return (
    ...
    >
      ...
      <p className="text-[10px] font-body text-cream/20">
        3 perguntas · 60 segundos · diagnóstico gratuito
      </p>
    </motion.div>
  );
}
  ...
  return (
    <div
      ...
      style={{
        ...
        transition:
          "transform 0.45s cubic-bezier(0.16,1,0.3,1), box-shadow 0.4s ease",
        cursor: "pointer",
      }}
    ...
    >
      {item.imageSrc ? (
        <img
          src={item.imageSrc.replace(
            "/upload/",
            "/upload/w_320,h_400,c_fill,q_auto,f_auto/",
          )}
          alt={item.label}
          loading="eager"
          decoding="async"
      ...
      >
        <div className="text-[10px] font-body text-cream/50 tracking-wider">
          {item.label}
        </div>
      </div>

      <div
        className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-gold/55 to-transparent pointer-events-none"
...
function SocialSection() {
  ...
  const allImages: AdItem[] = [
    {
      id: 1,
      label: "Imobiliário · São Paulo",
      imageSrc: "/social_media/Português.png",
    },
    {
      id: 2,
      label: "Clínica Estética · Rio",
      imageSrc: "/social_media/ORGANIZAGRAM BY CAROL RHEIN (15).png",
    },
    {
      id: 3,
      label: "Corporate · Fintech",
      imageSrc: "/social_media/Modelo lançamento (9).png",
    },
    {
      id: 4,
      label: "Lifestyle · Alto Padrão",
      imageSrc: "/social_media/Modelo lançamento (4).png",
    },
    {
      id: 5,
      label: "Real Estate · Litoral",
      imageSrc: "/social_media/ORGANIZAGRAM BY CAROL RHEIN (6).png",
    },
    { id: 6, label: "Dermatologia Premium", imageSrc: "/social_media/77.png" },
    { id: 7, label: "Odontologia Premium", imageSrc: "/social_media/18.png" },
    {
      id: 8,
      label: "Imóvel · Jardins SP",
      imageSrc: "/social_media/4.POST QUEM SOU EU BY CAROL RHEIN (3).png",
    },
    {
      id: 9,
      label: "Academia Premium",
      imageSrc: "/social_media/ORGANIZAGRAM BY CAROL RHEIN.png",
    },
    {
      id: 10,
      label: "Joalheria · Luxo",
      imageSrc: "/social_media/2.POST QUEM SOU EU BY CAROL RHEIN (2).png",
    },
    { id: 11, label: "Hotel Boutique", imageSrc: "/social_media/119.png" },
    {
      id: 12,
      label: "Cirurgia Plástica",
      imageSrc: "/social_media/1.POST QUEM SOU EU BY CAROL RHEIN.png",
    },
  ];
  ...
  const botRow = botImages.some((i) => i.imageSrc)
    ? botImages
    : [...allImages.slice(6), ...allImages.slice(0, 6)];

  // Shared layout constants
  const FW = "clamp(60px, 8vw, 120px)"; // gradient fade width
  const FL =
    "linear-gradient(90deg, rgba(0,0,0,0.97) 0%, rgba(0,0,0,0.75) 30%, rgba(0,0,0,0.30) 60%, transparent 100%)";
  const FR =
    "linear-gradient(-90deg, rgba(0,0,0,0.97) 0%, rgba(0,0,0,0.75) 30%, rgba(0,0,0,0.30) 60%, transparent 100%)";
  const BTN =
    "absolute top-1/2 -translate-y-1/2 w-9 h-9 rounded-full flex items-center justify-center text-gold transition-all duration-300 hover:scale-110 hover:border-gold/60 opacity-30 hover:opacity-90";
  const BTN_S = {
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ width: FW, background: FL }}
        />
        <div
          className="absolute inset-y-0 right-0 pointer-events-none"
          style={{ width: FW, background: FR }}
        />
        <button
          aria-label="Voltar"
          onClick={() => topCtrl.current?.nudge(NUDGE)}
          ...
          <div className="mt-6 flex justify-center gap-8 md:gap-14">
            {(
              ...
              <div key={label} className="text-center">
                <div
                  className="font-body font-light text-gold-soft tabular-nums"
      ...
      >
        ...
        <button
          aria-label="Voltar"
          onClick={() => botCtrl.current?.nudge(-NUDGE)}
          className={`${BTN} left-4`}
          style={BTN_S}
        >
          <ChevLeft />
...
function VideoCard({ v }: { v: VideoItem }) {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute left-0 top-0 bottom-0 w-[2px] bg-gradient-to-b from-transparent via-gold/45 to-transparent pointer-events-none"
...
function AudiovisualSection() {
  const videos: VideoItem[] = [
    {
      id: 1,
      label: "Imobiliário · São Paulo",
      videoSrc: "e2a645c3-7af9-4a7d-979e-f72d5bb69907",
    },
    {
      id: 2,
      label: "Veduta Residencial",
      videoSrc: "b96711b3-ea9c-4bc4-9afc-4e8c599c9d6e",
    },
    {
      id: 3,
      label: "Felipe Corretor · Drone",
      videoSrc: "04f363de-735c-4fbe-b70b-5b577c46c151",
    },
    {
      id: 4,
      label: "Lifestyle · Alto Padrão",
      videoSrc: "340e9e5a-9e47-4fa7-a5c7-23842c1c687e",
    },
    {
      id: 5,
      label: "Colinas do Mosteiro",
      videoSrc: "05c97387-7d2e-4807-b3b3-f55d7d97ceb3",
    },
    {
      id: 6,
      label: "Reserva Ermida",
      videoSrc: "4a28cb09-4a5b-46b2-9302-8fc70d6b5c7c",
    },
    {
      id: 7,
      label: "Vila Rica · Indaiatuba",
      videoSrc: "60c63f91-aac7-464b-959f-cd50fd68db72",
    },
    {
      id: 8,
      label: "Helvetia Park · Indaiatuba",
      videoSrc: "9eec0a0d-fb75-47e5-ae10-ac56e3eec1ae",
    },
  ];
  ...
  const BTN_VM =
    "absolute top-1/2 -translate-y-1/2 w-11 h-11 rounded-full flex items-center justify-center text-gold transition-all duration-300 hover:scale-110 hover:border-gold/60 z-20 opacity-40 hover:opacity-100";
  const BTN_VM_S = {
    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="font-body font-light text-cream/45 leading-relaxed max-w-sm mb-5 text-sm">
              Vídeo que para o scroll em 3 segundos e transforma visualização em
              desejo de compra. Roteiro, filmagem e edição com foco total em
              conversão.
            </p>
            <button
              onClick={() => openQuizModal()}
          ...
          <div className="grid grid-cols-3 gap-3">
            ...
            ).map(({ to, decimals, suffix, label }, i) => (
              <motion.div
                key={label}
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
      ...
      <div className="relative flex-1 flex flex-col justify-center">
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(0,0,0,0.96) 0%, rgba(0,0,0,0.35) 60%, transparent 100%)",
          }}
        />
        <div
        ...
        <button
          aria-label="Voltar"
          onClick={() => {
            posRef.current += VM_NUDGE;
          }}
          className={`${BTN_VM} left-5`}
          style={BTN_VM_S}
        >
          <svg
            width="16"
        ...
        <div
          ...
          onClickCapture={(e) => {
            if (dragOccurred.current) e.stopPropagation();
          }}
        >
          <div
            ref={innerRef}
...
function QuizModal({
  ...
  useEffect(() => {
    if (open && initialService) {
      setStep(1);
      setAnswers({ service: initialService });
    }
    if (!open) {
      setStep(0);
      setAnswers({});
    ...
    try {
      if (typeof (window as any).fbq === "function")
        (window as any).fbq("track", "Lead", {
          ...
          content_category: (payload as any).service,
        });
      if (typeof (window as any).gtag === "function")
        (window as any).gtag("event", "generate_lead", {
          event_category: "quiz",
          event_label: (payload as any).service,
        });
      ...
      {open && (
        ...
        >
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-6 right-6 text-cream/30 hover:text-cream/60 transition-colors"
            >
              <svg
                width="18"
                height="18"
            ...
            {!done ? (
                ...
                <div className="mb-8">
                  <div className="flex items-center gap-3 mb-3">
                    <span className="text-[10px] font-body tracking-[0.35em] uppercase text-gold/60">
                      Filtro de Elite —{" "}
                      {Math.min(step + 1, quizSteps.length + 1)}/
                      {quizSteps.length + 1}
                    </span>
                  ...
                  >
                    {!isContact
                      ...
                      : "Últimos detalhes para o diagnóstico"}
                  </h3>
                </div>
                      ...
                      return (
                        ...
                        >
                          {isFeatured && !isSelected && (
                            <span className="block text-[9px] tracking-[0.3em] uppercase text-gold/60 mb-0.5">
                              Mais popular
                            </span>
                          )}
                          {opt}
              ...
              <div className="text-center py-8">
                ...
                <p className="font-body font-light text-cream/45 text-sm leading-relaxed mb-8">
                  Nosso time entrará em contato via WhatsApp em até 24h com um
                  diagnóstico personalizado.
                </p>
                <button
                  onClick={reset}
                  className="text-xs font-body text-cream/30 hover:text-cream/60 tracking-widest uppercase transition-colors"
                >
                  Fechar
                </button>
              </div>
    ...
    <Section className="py-8 px-6 bg-obsidian/30">
      <div className="max-w-7xl mx-auto relative">
        <AmbientOrb
          ...
          height={700}
          speed={0.2}
          style={{ left: "50%", top: "-10%", marginLeft: -350 }}
        />
        ...
        <div className="text-center mb-20">
          ...
          >
            Resultados de Quem <span className="text-gold">Apostou</span>
          </h2>
          ...
          {testimonials.map((t, i) => (
            ...
            >
              <TiltCard className="glass rounded-2xl p-8 overflow-hidden group h-full">
                <div
                  className="absolute top-0 right-0 w-40 h-40 rounded-full blur-3xl opacity-0 group-hover:opacity-80 transition-opacity duration-700 pointer-events-none"
                  style={{
                ...
                />
                <div
                  className="font-display-italic text-gold/18 leading-none mb-4 select-none"
                  style={{ fontSize: "5rem", lineHeight: 0.8 }}
                >
                  "
                </div>
                <p className="font-body font-light text-cream/65 leading-relaxed text-sm mb-8">
                  {t.text}
                </p>
                <div className="inline-flex items-center gap-2 bg-gold/8 border border-gold/18 rounded-full px-4 py-1.5 mb-6">
                  <div className="w-1.5 h-1.5 rounded-full bg-gold" />
                  <span className="text-[10px] font-body font-medium text-gold tracking-wider uppercase">
                    {t.result}
                  </span>
                </div>
                <div className="flex items-center gap-3 pt-5 border-t border-cream/8">
                  <div
                    className="w-10 h-10 rounded-full flex items-center justify-center text-xs font-body font-medium text-void flex-shrink-0"
                    style={{ background: `hsl(${t.hue},25%,55%)` }}
                  >
                    {t.initials}
                  </div>
                  <div>
                    <div className="text-sm font-body font-medium text-cream/80">
                      {t.name}
                    </div>
                    <div className="text-[11px] font-body text-cream/30 mt-0.5">
                      {t.role}
                    </div>
                  </div>
                </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
          ...
          >
            ...
            <div className="glass rounded-2xl p-5 absolute -bottom-5 -right-5 shadow-2xl">
              <div className="text-2xl font-body font-light text-gold tabular-nums">
                +10M
              </div>
              <div className="text-[10px] font-body text-cream/35 uppercase tracking-widest mt-1">
                em capital gerenciado
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="text-[10px] font-body tracking-[0.4em] uppercase text-gold/55 mb-6">
              O Estrategista
            </div>
            <h2
              data-reveal-title
              className="font-display text-cream leading-[1.0] mb-8"
              style={{
                fontSize: "clamp(2.5rem, 5vw, 4rem)",
                letterSpacing: "-0.025em",
              }}
            ...
            <div className="space-y-5 font-body font-light text-cream/50 leading-relaxed text-[15px] max-w-lg">
              <p>
                Construí a HS Visual com uma convicção: cada negócio merece uma
                comunicação à altura do seu produto e do seu momento. Não aceito
                mediocridade — nem na estética, nem nos números.
              </p>
              <p>
                Passei anos estudando o que separa uma campanha que gasta de uma
                campanha que retorna. A resposta não está no volume — está na{" "}
                <span className="text-gold/80 font-normal">
                  precisão cirúrgica
                </span>{" "}
                de cada decisão criativa e estratégica.
              </p>
              <p>
                A HS Visual atende negócios de diferentes segmentos que estão
                prontos para crescer com estratégia, com especialidade no
                mercado imobiliário. Se é você, vamos conversar.
              </p>
            </div>
            <div className="mt-10 flex flex-wrap gap-4">
              {[
                ["12+", "Anos de experiência"],
                ["130+", "Marcas atendidas"],
                ["R$10M+", "Em capital gerenciado"],
              ].map(([val, label]) => (
                <div key={label} className="glass rounded-xl px-5 py-3">
                  <div className="text-xl font-body font-light text-gold tabular-nums">
                    {val}
                  </div>
                  <div className="text-[10px] font-body text-cream/30 uppercase tracking-wider mt-0.5">
                    {label}
                  </div>
                </div>
              ))}
...
function SystemsSection() {
  const nodes = [
    ...
    {
      icon: "◎",
      label: "IA responde em 2min",
      desc: "Qualificação automática em tempo real",
    },
    {
      icon: "◐",
      label: "Classificação",
      desc: "Comprador / Curioso / Descarte",
    },
    {
      icon: "◆",
      label: "Nurturing",
      desc: "Aquecimento automático até estar pronto",
    },
    {
      icon: "✦",
      label: "Você fecha a venda",
      desc: "Só chega quem tem intenção real",
    },
  ];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="font-body font-light text-cream/50 leading-relaxed max-w-md mb-8">
              ...
              minutos, ele recebe resposta, é qualificado e — se for comprador —
              chega até você pronto para fechar. Tudo automático.
            </p>
            <div className="flex flex-wrap gap-2">
              {[
                "Resposta em menos de 2 min",
                "Qualificação automática",
                "Só compradores chegam até você",
                "Funciona 24h por dia",
              ].map((tag) => (
                <span
                  key={tag}
                  className="text-[10px] font-body font-medium text-gold/60 border border-gold/15 rounded px-3 py-1 tracking-wider transition-all duration-300 hover:border-gold/40 hover:text-gold/90 hover:bg-gold/5 cursor-default"
                >
                  {tag}
                </span>
              ))}
          ...
          <div className="glass rounded-2xl p-8 relative overflow-hidden">
            ...
            <div
              className="absolute bottom-8 left-4 w-32 h-32 rounded-full blur-3xl pointer-events-none"
            ...
            <div className="flex flex-col gap-1 relative">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to bottom, rgba(197,164,103,0.08), rgba(197,164,103,0.20), rgba(197,164,103,0.45))",
                }}
              />
    ...
    <section className="py-8 px-6 border-t border-cream/5">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          ...
          >
            Nossas{" "}
            <span className="font-display-italic text-gold">Frentes</span>
          </motion.h3>
          <motion.p
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          {frentes.map((f, i) => (
            ...
            >
              ...
              <h4 className="font-body font-medium text-cream/85 text-sm mb-1">
                {f.title}
              </h4>
              <p className="font-body font-light text-cream/40 text-xs mb-4">
                {f.services}
              </p>
              <div className="inline-flex items-center gap-1.5 bg-gold/6 border border-gold/15 rounded-full px-3 py-1">
                <div className="w-1 h-1 rounded-full bg-gold/70" />
                <span className="text-[10px] font-body font-medium text-gold/80">
                  {f.metric}
                </span>
              </div>
            </motion.div>
  ...
  return (
    <section className="py-10 px-6 border-t border-cream/5">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-8">
          <div className="text-[10px] font-body tracking-[0.35em] uppercase text-gold/50 mb-3">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          <div>
            ...
            <p className="font-body font-light text-cream/55 text-sm leading-relaxed mb-3">
              ...
              <span className="text-cream/80 font-medium">Helder Show</span>,
              sediado em Jundiaí/SP, com operação estruturada para atender
              negócios de diferentes segmentos, com especialidade no mercado
              imobiliário, em qualquer estado do país.
            </p>
            <p className="font-body font-light text-cream/35 text-sm leading-relaxed mb-6">
              Nossa operação é 100% digital e estruturada para entregar
              resultados em qualquer cidade do Brasil — sem depender de presença
              física.
            </p>
            ...
            <div className="grid grid-cols-2 gap-1.5">
              {regioes.map((regiao, i) => (
                ...
                >
                  ...
                  <span className="font-body text-xs text-cream/55 tracking-wider">
                    {regiao}
                  </span>
                </motion.div>
              ))}
...
const QUIZ_SERVICES = [
  {
    label: "Vender Mais e Atrair Clientes",
    sub: "Tráfego Pago · Meta & Google Ads",
  },
  {
    label: "Redes Sociais Profissionais",
    sub: "Social Media · Conteúdo Estratégico",
  },
...
function QuizInlineSection() {
  return (
    <section
      className="py-8 px-6 border-t border-cream/5"
      style={{ scrollMarginTop: "88px" }}
    >
  ...
  return (
    <motion.footer
      ...
      style={{
        ...
        backgroundImage:
          "linear-gradient(#050505, #050505), linear-gradient(90deg, transparent, rgba(197,164,103,0.15), transparent)",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="py-6 flex flex-col md:flex-row items-center justify-between gap-6 md:gap-4">
          ...
          <div className="flex items-center gap-5 shrink-0">
            <a
              href="https://www.instagram.com/hsvisual.oficial/"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="mailto:contato@hsvisual.com"
        ...
        <div className="border-t border-cream/5 py-3 flex flex-col md:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-5">
            ...
            <span className="text-cream/10">·</span>
            <a
              href="/trafego-pago-jundiai"
              className="text-[10px] font-body font-light text-cream/30 hover:text-gold/70 transition-colors tracking-[0.15em] uppercase"
            >
              Tráfego Pago em Jundiaí
            </a>
          </div>
        </div>
      </div>
